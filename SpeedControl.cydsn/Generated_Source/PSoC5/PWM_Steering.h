...
***************************************/
#define PWM_Steering_Resolution                     (8u)
...
#if (!PWM_Steering_UsingFixedFunction)
    uint8   PWM_Steering_ReadCounter(void) ;
    uint8 PWM_Steering_ReadCapture(void) ;

    #if (PWM_Steering_UseStatus)
            void PWM_Steering_ClearFIFO(void) ;
    #endif /* (PWM_Steering_UseStatus) */

    void    PWM_Steering_WriteCounter(uint8 counter)
            ;
#endif /* (!PWM_Steering_UsingFixedFunction) */

void    PWM_Steering_WritePeriod(uint8 period)
        ;
uint8 PWM_Steering_ReadPeriod(void) ;

#if (PWM_Steering_UseOneCompareMode)
    void    PWM_Steering_WriteCompare(uint8 compare)
            ;
    uint8 PWM_Steering_ReadCompare(void) ;
#else
    void    PWM_Steering_WriteCompare1(uint8 compare)
            ;
    uint8 PWM_Steering_ReadCompare1(void) ;
    void    PWM_Steering_WriteCompare2(uint8 compare)
            ;
    uint8 PWM_Steering_ReadCompare2(void) ;
#endif /* (PWM_Steering_UseOneCompareMode) */
...
**************************************/
#define PWM_Steering_INIT_PERIOD_VALUE          (255u)
#define PWM_Steering_INIT_COMPARE_VALUE1        (127u)
...
******************************** */
   ...
   #define PWM_Steering_RT1_PTR                 ( (reg8 *)  PWM_Steering_PWMHW__RT1)
       ...
       #if(PWM_Steering_PWMModeIsCenterAligned)
           #define PWM_Steering_PERIOD_LSB      (*(reg8 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__D1_REG)
           #define PWM_Steering_PERIOD_LSB_PTR  ((reg8 *)   PWM_Steering_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #else
           #define PWM_Steering_PERIOD_LSB      (*(reg8 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__F0_REG)
           #define PWM_Steering_PERIOD_LSB_PTR  ((reg8 *)   PWM_Steering_PWMUDB_sP8_pwmdp_u0__F0_REG)
       #endif /* (PWM_Steering_PWMModeIsCenterAligned) */

       #define PWM_Steering_COMPARE1_LSB        (*(reg8 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define PWM_Steering_COMPARE1_LSB_PTR    ((reg8 *)   PWM_Steering_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define PWM_Steering_COMPARE2_LSB        (*(reg8 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define PWM_Steering_COMPARE2_LSB_PTR    ((reg8 *)   PWM_Steering_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define PWM_Steering_COUNTERCAP_LSB      (*(reg8 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define PWM_Steering_COUNTERCAP_LSB_PTR  ((reg8 *)   PWM_Steering_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define PWM_Steering_COUNTER_LSB         (*(reg8 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define PWM_Steering_COUNTER_LSB_PTR     ((reg8 *)   PWM_Steering_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define PWM_Steering_CAPTURE_LSB         (*(reg8 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__F1_REG)
       #define PWM_Steering_CAPTURE_LSB_PTR     ((reg8 *)   PWM_Steering_PWMUDB_sP8_pwmdp_u0__F1_REG)

   #else
        #if(CY_PSOC3) /* 8-bit address space */
            #if(PWM_Steering_PWMModeIsCenterAligned)
               #define PWM_Steering_PERIOD_LSB      (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__D1_REG)
               #define PWM_Steering_PERIOD_LSB_PTR  ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #else
               #define PWM_Steering_PERIOD_LSB      (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__F0_REG)
               #define PWM_Steering_PERIOD_LSB_PTR  ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__F0_REG)
            #endif /* (PWM_Steering_PWMModeIsCenterAligned) */

            #define PWM_Steering_COMPARE1_LSB       (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define PWM_Steering_COMPARE1_LSB_PTR   ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define PWM_Steering_COMPARE2_LSB       (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define PWM_Steering_COMPARE2_LSB_PTR   ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define PWM_Steering_COUNTERCAP_LSB     (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define PWM_Steering_COUNTERCAP_LSB_PTR ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define PWM_Steering_COUNTER_LSB        (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define PWM_Steering_COUNTER_LSB_PTR    ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define PWM_Steering_CAPTURE_LSB        (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__F1_REG)
            #define PWM_Steering_CAPTURE_LSB_PTR    ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__F1_REG)
        #else
            #if(PWM_Steering_PWMModeIsCenterAligned)
               #define PWM_Steering_PERIOD_LSB      (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
               #define PWM_Steering_PERIOD_LSB_PTR  ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #else
               #define PWM_Steering_PERIOD_LSB      (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
               #define PWM_Steering_PERIOD_LSB_PTR  ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
            #endif /* (PWM_Steering_PWMModeIsCenterAligned) */

            #define PWM_Steering_COMPARE1_LSB       (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define PWM_Steering_COMPARE1_LSB_PTR   ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define PWM_Steering_COMPARE2_LSB       (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define PWM_Steering_COMPARE2_LSB_PTR   ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define PWM_Steering_COUNTERCAP_LSB     (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define PWM_Steering_COUNTERCAP_LSB_PTR ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define PWM_Steering_COUNTER_LSB        (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define PWM_Steering_COUNTER_LSB_PTR    ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define PWM_Steering_CAPTURE_LSB        (*(reg16 *) PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
            #define PWM_Steering_CAPTURE_LSB_PTR    ((reg16 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
        #endif /* (CY_PSOC3) */

       #define PWM_Steering_AUX_CONTROLDP1          (*(reg8 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)
       #define PWM_Steering_AUX_CONTROLDP1_PTR      ((reg8 *)   PWM_Steering_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)

   #endif /* (PWM_Steering_Resolution == 8) */

   #define PWM_Steering_COUNTERCAP_LSB_PTR_8BIT ( (reg8 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__A1_REG)
   #define PWM_Steering_AUX_CONTROLDP0          (*(reg8 *)  PWM_Steering_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
   #define PWM_Steering_AUX_CONTROLDP0_PTR      ((reg8 *)   PWM_Steering_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
