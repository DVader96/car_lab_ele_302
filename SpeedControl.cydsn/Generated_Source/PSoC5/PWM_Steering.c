...
#ifdef PWM_Steering_PWMUDB_genblk1_ctrlreg__REMOVED
    #error PWM_v3_30 detected with a constant 0 for the enable or \
         constant 1 for reset. This will prevent the component from operating.
#endif /* PWM_Steering_PWMUDB_genblk1_ctrlreg__REMOVED */
...
void PWM_Steering_Init(void) 
{
        ...
        ctrl = PWM_Steering_CONTROL3 & ((uint8 )(~PWM_Steering_CTRL_CMPMODE1_MASK));
        PWM_Steering_CONTROL3 = ctrl | PWM_Steering_DEFAULT_COMPARE1_MODE;

         /* Clear and Set SYNCTC and SYNCCMP bits of RT1 register */
        PWM_Steering_RT1 &= ((uint8)(~PWM_Steering_RT1_MASK));
        PWM_Steering_RT1 |= PWM_Steering_SYNC;

        /*Enable DSI Sync all all inputs of the PWM*/
        PWM_Steering_RT1 &= ((uint8)(~PWM_Steering_SYNCDSI_MASK));
        PWM_Steering_RT1 |= PWM_Steering_SYNCDSI_EN;

    #elif (PWM_Steering_UseControl)
        /* Set the default compare mode defined in the parameter */
        ctrl = PWM_Steering_CONTROL & ((uint8)(~PWM_Steering_CTRL_CMPMODE2_MASK)) &
                ((uint8)(~PWM_Steering_CTRL_CMPMODE1_MASK));
...
{
    #if (PWM_Steering_UseControl || PWM_Steering_UsingFixedFunction)
        PWM_Steering_CONTROL &= ((uint8)(~PWM_Steering_CTRL_ENABLE));
    #endif /* (PWM_Steering_UseControl || PWM_Steering_UsingFixedFunction) */

    /* Globally disable the Fixed Function Block chosen */
    #if (PWM_Steering_UsingFixedFunction)
        PWM_Steering_GLOBAL_ENABLE &= ((uint8)(~PWM_Steering_BLOCK_EN_MASK));
        PWM_Steering_GLOBAL_STBY_ENABLE &= ((uint8)(~PWM_Steering_BLOCK_STBY_EN_MASK));
    #endif /* (PWM_Steering_UsingFixedFunction) */
}
        ...
        *******************************************************************************/
        void PWM_Steering_SetCompareMode(uint8 comparemode) 
        {
                ...
                #if(0 != PWM_Steering_CTRL_CMPMODE1_SHIFT)
                    uint8 comparemodemasked = ((uint8)((uint8)comparemode << PWM_Steering_CTRL_CMPMODE1_SHIFT));
                #else
                    uint8 comparemodemasked = comparemode;
                #endif /* (0 != PWM_Steering_CTRL_CMPMODE1_SHIFT) */

                PWM_Steering_CONTROL3 &= ((uint8)(~PWM_Steering_CTRL_CMPMODE1_MASK)); /*Clear Existing Data */
                PWM_Steering_CONTROL3 |= comparemodemasked;

            #elif (PWM_Steering_UseControl)

                #if(0 != PWM_Steering_CTRL_CMPMODE1_SHIFT)
                    uint8 comparemode1masked = ((uint8)((uint8)comparemode << PWM_Steering_CTRL_CMPMODE1_SHIFT)) &
                                                PWM_Steering_CTRL_CMPMODE1_MASK;
                #else
                    uint8 comparemode1masked = comparemode & PWM_Steering_CTRL_CMPMODE1_MASK;
                #endif /* (0 != PWM_Steering_CTRL_CMPMODE1_SHIFT) */

                #if(0 != PWM_Steering_CTRL_CMPMODE2_SHIFT)
                    uint8 comparemode2masked = ((uint8)((uint8)comparemode << PWM_Steering_CTRL_CMPMODE2_SHIFT)) &
                                               PWM_Steering_CTRL_CMPMODE2_MASK;
                #else
                    uint8 comparemode2masked = comparemode & PWM_Steering_CTRL_CMPMODE2_MASK;
                #endif /* (0 != PWM_Steering_CTRL_CMPMODE2_SHIFT) */

                /*Clear existing mode */
                PWM_Steering_CONTROL &= ((uint8)(~(PWM_Steering_CTRL_CMPMODE1_MASK |
                                            PWM_Steering_CTRL_CMPMODE2_MASK)));
        ...
        *******************************************************************************/
        void PWM_Steering_SetCompareMode1(uint8 comparemode) 
        {
                ...
                uint8 comparemodemasked = ((uint8)((uint8)comparemode << PWM_Steering_CTRL_CMPMODE1_SHIFT)) &
                                           PWM_Steering_CTRL_CMPMODE1_MASK;
            #else
                uint8 comparemodemasked = comparemode & PWM_Steering_CTRL_CMPMODE1_MASK;
            #endif /* (0 != PWM_Steering_CTRL_CMPMODE1_SHIFT) */

            #if (PWM_Steering_UseControl)
                PWM_Steering_CONTROL &= ((uint8)(~PWM_Steering_CTRL_CMPMODE1_MASK)); /*Clear existing mode */
    ...
    *******************************************************************************/
    void PWM_Steering_SetCompareMode2(uint8 comparemode) 
    {
        ...
        #if(0 != PWM_Steering_CTRL_CMPMODE2_SHIFT)
            uint8 comparemodemasked = ((uint8)((uint8)comparemode << PWM_Steering_CTRL_CMPMODE2_SHIFT)) &
                                                 PWM_Steering_CTRL_CMPMODE2_MASK;
        #else
            uint8 comparemodemasked = comparemode & PWM_Steering_CTRL_CMPMODE2_MASK;
        #endif /* (0 != PWM_Steering_CTRL_CMPMODE2_SHIFT) */

        #if (PWM_Steering_UseControl)
            PWM_Steering_CONTROL &= ((uint8)(~PWM_Steering_CTRL_CMPMODE2_MASK)); /*Clear existing mode */
            PWM_Steering_CONTROL |= comparemodemasked;
        #endif /* (PWM_Steering_UseControl) */
    }
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_Steering_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWM_Steering_ReadCounter(void) 
    {
        ...
        /* It is up to the user code to make sure there isn't already captured data in the FIFO */
          (void)CY_GET_REG8(PWM_Steering_COUNTERCAP_LSB_PTR_8BIT);

        /* Read the data from the FIFO */
        return (CY_GET_REG8(PWM_Steering_CAPTURE_LSB_PTR));
    }
        ...
        *******************************************************************************/
        ...
        {
            while(0u != (PWM_Steering_ReadStatusRegister() & PWM_Steering_STATUS_FIFONEMPTY))
            {
                (void)PWM_Steering_ReadCapture();
            }
        }
...
void PWM_Steering_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_Steering_PERIOD_LSB_PTR, period);
    #endif /* (PWM_Steering_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWM_Steering_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_Steering_UsingFixedFunction) */

        #if (PWM_Steering_PWMMode == PWM_Steering__B_PWM__DITHER)
            #if(PWM_Steering_UsingFixedFunction)
                CY_SET_REG16(PWM_Steering_COMPARE2_LSB_PTR, (uint16)(compare + 1u));
            #else
                CY_SET_REG8(PWM_Steering_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_Steering_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWM_Steering_COMPARE2_LSB_PTR, compare);
        #endif /* (PWM_Steering_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    void PWM_Steering_WriteDeadTime(uint8 deadtime) 
    {
        /* If using the Dead Band 1-255 mode then just write the register */
            ...
            /* Clear existing data */
            PWM_Steering_DEADBAND_COUNT &= ((uint8)(~PWM_Steering_DEADBAND_COUNT_MASK));

            /* Set new dead time */
            #if(PWM_Steering_DEADBAND_COUNT_SHIFT)
                PWM_Steering_DEADBAND_COUNT |= ((uint8)((uint8)deadtime << PWM_Steering_DEADBAND_COUNT_SHIFT)) &
                                                    PWM_Steering_DEADBAND_COUNT_MASK;
            #else
                PWM_Steering_DEADBAND_COUNT |= deadtime & PWM_Steering_DEADBAND_COUNT_MASK;
            #endif /* (PWM_Steering_DEADBAND_COUNT_SHIFT) */
    ...
    *******************************************************************************/
    uint8 PWM_Steering_ReadDeadTime(void) 
    {
        /* If using the Dead Band 1-255 mode then just read the register */
            ...
            /* Otherwise the data has to be masked and offset */
            #if(PWM_Steering_DEADBAND_COUNT_SHIFT)
                return ((uint8)(((uint8)(PWM_Steering_DEADBAND_COUNT & PWM_Steering_DEADBAND_COUNT_MASK)) >>
    ...
    /*******************************************************************************
    * Function Name: PWM_Steering_SetInterruptMode
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_Steering_STATUS_MASK_PTR, interruptMode);
    }


    /*******************************************************************************
    * Function Name: PWM_Steering_ReadStatusRegister
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_Steering_STATUS_PTR));
    }
    ...
    /*******************************************************************************
    * Function Name: PWM_Steering_ReadControlRegister
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 PWM_Steering_ReadControlRegister(void) 
    {
        ...
        result = CY_GET_REG8(PWM_Steering_CONTROL_PTR);
        return (result);
    }


    /*******************************************************************************
    * Function Name: PWM_Steering_WriteControlRegister
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_Steering_CONTROL_PTR, control);
    }
    ...
    /*******************************************************************************
    * Function Name: PWM_Steering_ReadCapture
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: PWM_Steering_ReadCompare
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_Steering_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_Steering_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_Steering_COMPARE1_LSB_PTR));
        #endif /* (PWM_Steering_UsingFixedFunction) */
    }
    ...
    /*******************************************************************************
    * Function Name: PWM_Steering_ReadCompare1
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: PWM_Steering_ReadCompare2
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_Steering_COMPARE2_LSB_PTR));
    }
...
/*******************************************************************************
* Function Name: PWM_Steering_ReadPeriod
********************************************************************************
*
* Summary:
...
{
    #if(PWM_Steering_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_Steering_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_Steering_PERIOD_LSB_PTR));
    #endif /* (PWM_Steering_UsingFixedFunction) */
}
    ...
    /*******************************************************************************
    * Function Name: PWM_Steering_WriteKillTime
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_Steering_KILLMODEMINTIME_PTR, killtime);
    }


    /*******************************************************************************
    * Function Name: PWM_Steering_ReadKillTime
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_Steering_KILLMODEMINTIME_PTR));
    }
